...
// En d'autres termes, Groovy prend en charge l'accés aux paires clé-valeur é la maniére d'un bean.
// Nous pouvons également utiliser des variables au lieu de littéraux comme clés lors de l'ajout de nouveaux éléments é la Map
